...
INSERT INTO "new_SponsorAd" ("createdAt", "eventId", "id", "imageUrl", "linkUrl", "name", "sortOrder", "tier") SELECT "createdAt", "eventId", "id", "imageUrl", "linkUrl", "name", "sortOrder", "tier" FROM "SponsorAd";
